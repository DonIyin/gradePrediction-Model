...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption("Iyinoluwa Don-Taiwo · McPherson University")
...
| 💡 **Feature Insights** | Feature importance chart, pass rate by feature value |
    ...
    st.markdown("---")
    st.caption("Dataset: Cortez, P. (2008). Student Performance [Dataset]. UCI Machine Learning Repository. https://doi.org/10.24432/C5TG7T")
